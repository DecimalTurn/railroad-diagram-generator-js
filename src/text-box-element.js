...
class TextBoxElement extends LayoutElement {
    ...
    /**
     * Calculate layout dimensions based on text content and LayoutConfig
     * @param {LayoutConfig} layoutConfig - Configuration for layout calculations
     * @returns {void}
     */
    layout(layoutConfig) {
        const { fontSize, fontFamily, gridSize } = layoutConfig;
...
module.exports = { TextBoxElement, measureText };